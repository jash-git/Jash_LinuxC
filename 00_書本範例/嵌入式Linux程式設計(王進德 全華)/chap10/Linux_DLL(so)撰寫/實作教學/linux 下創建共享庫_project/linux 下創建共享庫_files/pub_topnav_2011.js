...
document.write('<div id="ipad_adverting" style="position:fixed; bottom:0px; width:100%;"><a onclick=document.getElementById("ipad_adverting").style.display="none" style="position:absolute; top:0px; right:0px; width:4%; height:30%;display:inline-block;cursor:hand;"></a><a href="http://itunes.apple.com/cn/app/cheng-xu-yuan-za-zhi/id544773337" target="_blank"><img src="http://articles.csdn.net/uploads/allimg/120904/167_1130447081.gif" width="100%"/></a></div>'); 
} 