...
**
** Created: Mon Oct 22 10:48:04 2007
...
QMetaObject* AnalogClock::staticMetaObject()
{
    ...
    static const QUMethod slot_1 = {"drawClock", 1, param_slot_1 };
    static const QUMethod slot_2 = {"timeout", 0, 0 };
    static const QMetaData slot_tbl[] = {
	{ "setTime(const QTime&)", &slot_0, QMetaData::Public },
	{ "drawClock(QPainter*)", &slot_1, QMetaData::Private },
	{ "timeout()", &slot_2, QMetaData::Private }
    };
...
bool AnalogClock::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 1: drawClock((QPainter*)static_QUType_ptr.get(_o+1)); break;
