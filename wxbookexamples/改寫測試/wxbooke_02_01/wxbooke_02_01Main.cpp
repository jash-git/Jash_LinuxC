...
BEGIN_EVENT_TABLE(wxbooke_02_01Dialog, wxDialog)
    EVT_CLOSE(wxbooke_02_01Dialog::OnClose)
    EVT_BUTTON(idBtnQuit, wxbooke_02_01Dialog::OnQuit)
    EVT_BUTTON(idBtnAbout, wxbooke_02_01Dialog::OnAbout)
END_EVENT_TABLE()

wxbooke_02_01Dialog::wxbooke_02_01Dialog(wxDialog *dlg, const wxString &title)
...
wxbooke_02_01Dialog::~wxbooke_02_01Dialog()
{
}

void wxbooke_02_01Dialog::OnClose(wxCloseEvent &event)
{
    Destroy();
}

void wxbooke_02_01Dialog::OnQuit(wxCommandEvent &event)
{
    Destroy();
}

void wxbooke_02_01Dialog::OnAbout(wxCommandEvent &event)
{
